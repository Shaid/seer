 ...
 * or bitmap format your target game actually uses. Add your own
 * format-specific loader (e.g. `loadArchive()`) alongside your container
 * decoder once you've reverse-engineered it.
 */
